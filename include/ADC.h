...
#define ADC_CHSELR
#define ADC_IER_0_EOSEQIE    EOSEQIE              // 1 bits @ 3
#define ADC_IER_0_AWDIE      AWDIE                // 1 bits @ 7
#define ADC_ISR_0_EOSEQ      EOSEQ                // 1 bits @ 3
#define ADC_ISR_0_AWD        AWD                  // 1 bits @ 7
#define ADC_SMPR
#define ADC_TR
...
#define ADC_IER_0_EOSEQIE
#define ADC_IER_0_AWDIE
#define ADC_ISR_0_EOSEQ
#define ADC_ISR_0_AWD
...
#define ADC_CFGR2_1
    ...
    defined(STM32L083xx )
#define ADC_CHSELR_0_CHSEL16 CHSEL16              // 1 bits @ 16
#else
#define ADC_CHSELR_0_CHSEL16
#endif
...
#define ADC_ISR_1_ADRD
    ...
    defined(STM32F328xx ) || defined(STM32F334x8 ) || defined(STM32F358xx ) || defined(STM32F398xx ) ||\
    defined(STM32L4     ) || defined(STM32L4P    )
#define ADC_IER_1_EOSIE      EOSIE                // 1 bits @ 3
#define ADC_IER_1_AWD1IE     AWD1IE               // 1 bits @ 7
#else
#define ADC_IER_1_EOSIE
#define ADC_IER_1_AWD1IE
#endif
            ...
            struct CHSELR_TypeDef : public Reg32_t
			{
				...
				union
				{
					struct
					{
						...
						uint32_t CHSEL14              :1;
						uint32_t CHSEL15              :1;
						uint32_t ADC_CHSELR_0_CHSEL16 :1;
						uint32_t CHSEL17              :1;
						uint32_t CHSEL18              :1;
						uint32_t                      :13;
					};
            ...
            struct IER_TypeDef : public Reg32_t
			{
				...
				union
				{
					...
					struct
					{
						...
						uint32_t EOSMPIE              :1;
						uint32_t EOCIE                :1;
						uint32_t ADC_IER_0_EOSEQIE    :1;
						uint32_t OVRIE                :1;
						uint32_t ADC_IER_0_JEOCIE     :1;
						uint32_t ADC_IER_0_JEOSIE     :1;
						uint32_t ADC_IER_0_AWDIE      :1;
            ...
            struct ISR_TypeDef : public Reg32_t
			{
				...
				union
				{
					struct
					{
						...
						uint32_t EOSMP                :1;
						uint32_t EOC                  :1;
						uint32_t ADC_ISR_0_EOSEQ      :1;
						uint32_t OVR                  :1;
						uint32_t ADC_ISR_0_JEOC       :1;
						uint32_t ADC_ISR_0_JEOS       :1;
						uint32_t ADC_ISR_0_AWD        :1;
...
#undef ADC_IER_0_EOSEQIE
#undef ADC_IER_0_AWDIE
#undef ADC_ISR_0_EOSEQ
#undef ADC_ISR_0_AWD
...
#undef ADC_IER_1_EOSIE
#undef ADC_IER_1_AWD1IE
