...
#define USART_CR1_0_M0       M0                   // 1 bits @ 12
#else
...
#define USART_MAP0_PRESC __SOOL_PERIPH_PADDING_4
    ...
    defined(STM32F2     ) || defined(STM32F302xC ) || defined(STM32F303xC ) || defined(STM32F358xx ) ||\
    defined(STM32F373xC ) || defined(STM32F378xx ) || defined(STM32F4     ) || defined(STM32L1     )
#define USART_CR1_1
#endif
