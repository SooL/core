...
//Generated 2020-02-21T22:51:46.480340
...
#define RCC_AHBENR_0_GPIOPDEN GPIOPDEN
#define RCC_AHBENR_1_GPIOPBEN GPIOPBEN
#define RCC_AHBENR_1_GPIOPCEN GPIOPCEN
#define RCC_AHBENR_1_FLITFEN FLITFEN
#define RCC_AHBENR_2_GPIOPAEN GPIOPAEN
...
#define RCC_AHBENR_0_GPIOPDEN
#define RCC_AHBENR_1_GPIOPBEN
#define RCC_AHBENR_1_GPIOPCEN
#define RCC_AHBENR_1_FLITFEN
#define RCC_AHBENR_2_GPIOPAEN
...
#define RCC_IOPENR_IOPHEN IOPHEN
...
#define RCC_IOPENR_IOPEEN IOPEEN
...
#define RCC_AHBENR_1_RNGEN RNGEN
...
#define RCC_APBRSTR1
#define RCC_APBRSTR2
#define RCC_IOPENR_IOPFEN IOPFEN
#define RCC_APBENR1
#define RCC_APBENR2
#define RCC_IOPSMENR
...
#define RCC_AHBENR_2_TOUCHEN TOUCHEN
...
#define RCC_AHBENR_0_GPIOPHEN GPIOPHEN
#define RCC_AHBENR_0_GPIOPGEN GPIOPGEN
#define RCC_AHBENR_1_GPIOPEEN GPIOPEEN
#define RCC_AHBENR_1_GPIOPFEN GPIOPFEN
...
#else
#define RCC_AHBENR_0_GPIOPHEN
#define RCC_AHBENR_0_GPIOPGEN
#define RCC_AHBENR_1_GPIOPEEN
#define RCC_AHBENR_1_GPIOPFEN
...
#if	defined(STM32F0      ) || defined(STM32G0      ) || defined(STM32L0      ) || defined(STM32L1      ) || defined(STM32F302xE  ) || \
    defined(STM32F303xE  )
#define RCC_AHBENR_1
#endif
	...
	namespace core {
		class RCC /// rcc
		{
			...
			struct AHBENR_t: Reg32_t /// AHB Peripheral Clock enable register (RCC_AHBENR)
			{
				...
				union
				{
					struct
					{
						...
						uint32_t RCC_AHBENR_0_GPIOPDEN : 1; /// IO port D clock enable
						uint32_t RCC_AHBENR_0_FLITFEN : 1; /// FLITF clock enable
						uint32_t RCC_AHBENR_0_GPIOPHEN : 1; /// IO port H clock enable
						uint32_t RCC_AHBENR_0_CRCEN : 1; /// CRC clock enable
						uint32_t RCC_AHBENR_0_GPIOPGEN : 1; /// IO port G clock enable
					...
					struct
					{
						...
						uint32_t RCC_AHBENR_1_GPIOPBEN : 1; /// IO port B clock enable
						uint32_t RCC_AHBENR_1_GPIOPCEN : 1; /// IO port C clock enable
						uint32_t                  : 1;
						uint32_t RCC_AHBENR_1_GPIOPEEN : 1; /// IO port E clock enable
						uint32_t                  : 1;
						uint32_t RCC_AHBENR_1_GPIOPFEN : 1; /// IO port F clock enable
						uint32_t                  : 1;
						...
						uint32_t                  : 1;
						uint32_t RCC_AHBENR_1_RNGEN : 1; /// Random number generator clock enable
						uint32_t                  : 5;
					...
					struct
					{
						uint32_t RCC_AHBENR_2_GPIOPAEN : 1; /// IO port A clock enable
						uint32_t                  : 15;
						uint32_t RCC_AHBENR_2_TOUCHEN : 1; /// Touch Sensing clock enable bit
						uint32_t                  : 3;
						uint32_t RCC_AHBENR_2_RNGEN : 1; /// Random Number Generator clock enable bit
						uint32_t                  : 3;
					...
					{
						uint32_t                  : 24;
						uint32_t DMAEN            : 1; /// DMA1 clock enable
						uint32_t                  : 7;
					};
					#endif
				};
			...
			struct IOPENR_t: Reg32_t /// GPIO clock enable register
			{
				...
				uint32_t RCC_IOPENR_IOPEEN : 1; /// IO port E clock enable bit
				uint32_t RCC_IOPENR_IOPFEN : 1; /// I/O port F clock enable
				uint32_t                  : 1;
				uint32_t RCC_IOPENR_IOPHEN : 1; /// I/O port H clock enable bit
				uint32_t                  : 24;
...
//Instances for peripheral RCC
		...
		#else
			volatile class RCC * const RCC = new RCC();
			#undef RCC_BASE_ADDR
			#define RCC_BASE_ADDR reinterpret_cast<uint32_t>(RCC)
		#endif
